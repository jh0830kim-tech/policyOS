"""Strict deterministic primitives for the immutable runtime registry."""
...
NonNegativeInt = Annotated[int, Field(strict=True, ge=0, le=1_000_000)]
...
class RuntimeRegistryModel(BaseModel):
