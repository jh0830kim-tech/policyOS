...
## Sprint 7 Knowledge Provider Framework
The Knowledge Router can now use a capability-driven provider registry, selector, bounded fallback policy, execution boundary, evidence normalization, and compatibility adapter. Transport-specific MCP, OpenAPI, database, and internal retrieval details remain behind allowlisted adapters.
