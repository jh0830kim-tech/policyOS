...
| CP9-Gate-Production-Dependency-Bundle-Factory-Graph-and-Transport-Neutral-Observer-Ownership | Governed, validated, pending review | Production composition governance | ADR-107 fixes the immutable factory graph, exact upstream output, async request scope, transport-neutral disconnect signal, and bounded unavailable composition | Governance only; no public contract, production route, persistence, or migration `20260808_0025` |
