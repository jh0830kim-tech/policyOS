...
The existing RAG and Router contracts remain compatible through a provider-router adapter. Internal hybrid/vector results can be normalized as provider evidence without trusting raw similarity as final confidence.
